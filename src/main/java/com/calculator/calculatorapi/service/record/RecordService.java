...
public class RecordService {
    ...
    protected Page<Record> getRecordsByOperationType(int pageNumber,
                                                   int pageSize,
    ...
    @Transactional(propagation = Propagation.MANDATORY)
    protected Page<Record> getRecords(int pageNumber, int pageSize, User user) {
