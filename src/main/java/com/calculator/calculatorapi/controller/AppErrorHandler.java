...
public class AppErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<StandardResponseDto<?>> handler(UsernameNotFoundException ex, WebRequest request) {
        return new ResponseEntity<>(buildStandardResponse(ex.getMessage(), "User not found")
